...
<html>
	...
	<body>
		<div class="bg">
			...
			<center><h1>Credit Card Payment</h1><br>
			<div style="width:500px;height:400px;border:3px solid #000"><br><br>
			<form name="myForm" action="pay.php" target="_blank" method="POST">
			<input type="text" name="name" placeholder="Name on card">
			<br><br>
			<input type="text" name="number" placeholder="Card No" required>
			<br><br>
			...
			<input type="button" value="Cash Payment" onclick = "window.location.href='notice1.html'">
			</center></form>
